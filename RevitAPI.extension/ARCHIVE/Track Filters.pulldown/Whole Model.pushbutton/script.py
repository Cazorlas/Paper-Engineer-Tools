...
# -*- coding: utf-8 -*-
'''
Function: Track Filter In Whole Model Can Control Your Element.
-----------------------------------------------------------------
...
allFilter =  FilteredElementCollector(doc)\
            .OfClass(DB.ParameterFilterElement)\
            .ToElements()
filterIdList = [filter.Id for filter in allFilter]
...
affectFilter = []
if len(filterName) == 0:
    TaskDialog.Show("Result","There is no filter in your model.")
else:
